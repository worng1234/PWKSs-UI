    ...
    data() {
        return {
            menu: [
                ...
                { id: 2, menuName: 'เพิ่มรายวิชา', link: '/teacherSubject', icon: 'mdi:book-plus' },
                { id: 3, menuName: 'ตารางสอน', link: '/manageSchedule', icon: 'material-symbols:calendar-month' },
                { id: 4, menuName: 'ครูที่ปรึกษา', link: '/teacherConsult', icon: 'material-symbols:contacts-product' },
                { id: 5, menuName: 'เช็คชื่อ', link: '/attandance', icon: 'material-symbols:check-circle-rounded' },
                { id: 6, menuName: 'ตารางรวม', link: '/scheduleAll', icon: 'mdi:wallet-outline' },
                { id: 7, menuName: 'ห้องเรียน', link: '/homeRoom', icon: 'material-symbols:school-rounded' },
                { id: 8, menuName: 'โปรไฟล์', link: '/profile', icon: 'material-symbols:settings-account-box' },
