                    ...
                    <table class="table" align="center">
                        <thead class="fs-head" align="center">
                            <tr>
                                <th scope="col" class="th-color-main fm-kanit fw-500" style="border-radius: 8px 0 0 0;">
                                    ลำดับ</th>
                                <th scope="col" class="th-color-main fm-kanit fw-500">เลขที่</th>
                                <th scope="col" class="th-color-main fm-kanit fw-500">ชื่อ - นามสกุล</th>
                        ...
                        <tbody align="center" v-for="(data, index) in dataAttend">
                            <tr>
                                ...
                                <td class="fw-500">{{ data.studentCode }}</td>
